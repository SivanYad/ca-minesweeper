...
function addRandomMines(minesAmount) {
  ...
  for (var i = 0; i < minesAmount; i++) {
    ...
    var idx = getRandomInt(0, freeCells.length - 1);
    cell.i = freeCells[idx].i;
    cell.j = freeCells[idx].j;
...
//   elSafeBtn.innerText = `Safe Clicks: ${gGame.safeClicks}`
// }

function getSafeClick() {
  console.log(gBoard)
  var freeCells = checkFreeCells()
  var idx = getRandomInt(0, freeCells.length - 1);
  console.log(freeCells)
  console.log(freeCells[idx])
}